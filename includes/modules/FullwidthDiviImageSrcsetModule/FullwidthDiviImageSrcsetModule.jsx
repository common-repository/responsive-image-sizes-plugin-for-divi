...
class FullwidthDiviImageSrcsetModule extends AjaxComponent {

    static slug = 'et_pb_wptools_fullwidth_image';
    static global_module_index = 0;


    componentDidMount() {
        this.setState({
            module_index: FullwidthDiviImageSrcsetModule.global_module_index
        });
        FullwidthDiviImageSrcsetModule.global_module_index++;
    ...
    _reloadData(props) {
        return {
            ...
            object: [{
                type: 'et_pb_wptools_fullwidth_image',
                content: '',
                attrs: props,
                raw_child_content: ''
            }]
...
export default FullwidthDiviImageSrcsetModule;